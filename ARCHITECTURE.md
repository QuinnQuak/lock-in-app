...
> **Stage 6 steps 1–2 landed (2026-07-15):** palette/typography and the theme picker below are shipped, replacing the amber/green/Quicksand scheme. Still queued from Stage 6: mascot "blob buddy," Sparkles currency, trophy case, Shop — see `CONTEXT.md`'s Design Direction and `NEXT_SESSION.md` for build order.
