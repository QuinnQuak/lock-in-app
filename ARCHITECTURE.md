...
> **Stage 6 step 1 landed (2026-07-15):** the palette + typography swap below is now shipped, replacing the amber/green/Quicksand scheme. Still queued from Stage 6: theme picker (Peach/Berry/Sunset), mascot "blob buddy," Sparkles currency, trophy case, Shop — see `CONTEXT.md`'s Design Direction and `NEXT_SESSION.md` for build order.
...
| `Theme.kt` | Bubblegum colors, Fredoka/Nunito typography, bumped `Shapes`, `LockInTheme` |
